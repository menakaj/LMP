...
mv server.key ../certificates/Server.key
mv server.crt ../certificates/Server.crt
mv cacert.crt ../certificates/CA.crt
mv identity.crt ../certificates/identity.crt
mv identity.p12 ../certificates/Identity.p12
